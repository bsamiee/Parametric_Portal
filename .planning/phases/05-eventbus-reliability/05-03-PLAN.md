...
Pattern: Config-driven, availability check, graceful degradation. Optional layer for development debugging.
  </action>
  <verify>
...
3. If channel() doesn't exist, note for summary.

4. Check for broadcast() method - deprecate similarly if found:
