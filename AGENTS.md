...
3. Run full repository quality gate before completion.
...
- Always run Python checks: `pnpm py:check`

### TypeScript / React
- `pnpm ts:check`
- Preferred targeted variant during iteration: `pnpm ts:check:affected`
...
- TypeScript: follow `CLAUDE.md` + `REQUIREMENTS.md` strict schema-first / Effect-first approach.
