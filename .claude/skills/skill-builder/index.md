...
|   [7]   | Template    | [→simple.skill.template.md](templates/simple.skill.template.md)     | Minimal skill scaffold.                         |
|   [8]   | Template    | [→standard.skill.template.md](templates/standard.skill.template.md) | Reference-backed skill scaffold.                |
|   [9]   | Template    | [→complex.skill.template.md](templates/complex.skill.template.md)   | Multi-domain skill scaffold.                    |
