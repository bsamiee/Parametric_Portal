...
const _CONFIG = {
    catalog: {
        admin:          ['listUsers', 'listSessions', 'deleteSession', 'revokeSessionsByIp', 'listJobs', 'cancelJob', 'listDlq', 'replayDlq', 'listNotifications', 'replayNotification', 'events', 'ioDetail', 'ioConfig', 'statements', 'cacheRatio', 'walInspect', 'kcache', 'qualstats', 'waitSampling', 'waitSamplingCurrent', 'waitSamplingHistory', 'resetWaitSampling', 'cronJobs', 'partitionHealth', 'partmanConfig', 'runPartmanMaintenance', 'syncCronJobs', 'squeezeStatus', 'squeezeStartWorker', 'squeezeStopWorker', 'listTenants', 'createTenant', 'getTenant', 'updateTenant', 'deactivateTenant', 'resumeTenant', 'archiveTenant', 'purgeTenant', 'getTenantOAuth', 'updateTenantOAuth', 'listPermissions', 'grantPermission', 'revokePermission', 'getFeatureFlags', 'setFeatureFlag'],
