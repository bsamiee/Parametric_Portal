...
const _CONFIG = {
    catalog: {
        admin: [
            'listUsers', 'listSessions', 'deleteSession',
            'revokeSessionsByIp', 'listJobs', 'cancelJob',
            'listDlq', 'replayDlq', 'listNotifications',
            'replayNotification', 'events',
            'ioDetail', 'ioConfig', 'statements', 'cacheRatio',
            'walInspect', 'kcache', 'qualstats',
            'waitSampling', 'waitSamplingCurrent',
            'waitSamplingHistory', 'resetWaitSampling',
            'cronJobs', 'cronHistory', 'cronFailures',
            'partitionHealth', 'partmanConfig',
            'runPartmanMaintenance', 'syncCronJobs',
            'squeezeStatus', 'squeezeStartWorker',
            'squeezeStopWorker',
            'deadTuples', 'tableBloat', 'indexBloat',
            'lockContention', 'longRunningQueries',
            'connectionStats', 'replicationLag',
            'indexUsage', 'tableSizes', 'unusedIndexes',
            'seqScanHeavy', 'indexAdvisor',
            'hypotheticalIndexes', 'createHypotheticalIndex',
            'resetHypotheticalIndexes',
            'visibility',
            'buffercacheSummary', 'buffercacheUsage',
            'buffercacheTop', 'prewarmRelation',
            'listTenants', 'createTenant', 'getTenant',
            'updateTenant', 'deactivateTenant', 'resumeTenant',
            'archiveTenant', 'purgeTenant',
            'getTenantOAuth', 'updateTenantOAuth',
