...
const COMPONENT_FEATURES = Object.freeze({
	...
	select: ['async', 'interactions', 'theme', 'accessibility', 'form', 'formField', 'overlay', 'focusWrap', 'refs', 'slot', 'tooltip', 'disabledKeys', 'orientation', 'badge'] as const,
	selectItem: ['interactions', 'hover', 'press', 'accessibility', 'link', 'refs', 'slot', 'iconSlot', 'id', 'tooltip', 'badge'] as const,
	selectSection: ['accessibility', 'slot', 'id', 'disabledKeys'] as const,
