...
import {
	Button as RACButton, FieldError, Input, Label, Text,
	SearchField as RACSearchField, type SearchFieldProps as RACSearchFieldProps,
...
const SearchField: FC<SearchFieldProps> = ({
	className, clearIcon, color, description, errorMessage, label, placeholder, ref, searchIcon, size, tooltip, variant, ...racProps
}) => {
	...
	return (
		<>
			<RACSearchField
				{...(racProps as RACSearchFieldProps)}
				{...tooltipProps}
			...
			>
				...
				<div className={B.slot.inputWrapper} data-slot='search-field-input-wrapper'>
					{Slot.render(searchIcon, undefined, B.slot.searchIcon)}
					...
					<RACButton className={B.slot.clearButton} data-slot='search-field-clear'>
						{Slot.render(clearIcon, undefined, B.slot.clearIcon)}
					</RACButton>
				</div>
