 ...
 */
import { SessionContext } from '@parametric-portal/devtools/session';
import type { LogEntry } from '@parametric-portal/devtools/types';
...
const useDevSession = (): DevSessionHook => {
    ...
    const hide = useCallback((): void => {
        // Overlay is replaced by re-render; no explicit hide needed
    }, []);
