...
const _REGISTRY = (<const T extends Record<string, _RawEntry>>(table: T) => Object.fromEntries((Object.keys(table) as (keyof T & string)[]).map(key => [key, { ...table[key], field: key }])) as { [K in keyof T]: T[K] & { readonly field: K } })({
	...
	tokens:           { col: 'tokens',           sql: 'JSONB',       ts: 'S.Struct({access:S.String,refresh:S.String})', mark: 'sensitive', gen: false, null: false, ref: false, wrap: [_WRAP_META.Sensitive] },
	expiry:           { col: 'expiry',           sql: 'JSONB',       ts: 'S.Struct({access:S.DateFromSelf,refresh:S.DateFromSelf})', mark: 'exp', gen: false, null: false, ref: false, wrap: false },
	...
	auditContext:     { col: 'context',          sql: 'JSONB',       ts: 'S.Unknown',         mark: false,       gen: false,    null: true,  ref: false,      wrap: [_WRAP_META.FieldOption]                                },
	target:           { col: 'target',           sql: 'JSONB',       ts: 'S.Struct({type:S.String,id:S.UUID})', mark: false, gen: false, null: false, ref: false, wrap: false },
	retry:            { col: 'retry',            sql: 'JSONB',       ts: 'S.Struct({current:S.Number,max:S.Number})', mark: false, gen: false, null: false, ref: false, wrap: false },
	...
	dlqContext:       { col: 'context',          sql: 'JSONB',       ts: 'S.Unknown',         mark: false,       gen: false,    null: true,  ref: false,      wrap: [_WRAP_META.FieldOption]                                },
	authenticator:    { col: 'authenticator',    sql: 'JSONB',       ts: 'S.Struct({device:S.String,backedUp:S.Boolean,transports:S.Array(S.String)})', mark: false, gen: false, null: false, ref: false, wrap: false },
...
const _TABLES = {
	...
	sessions:         { fields: [_REGISTRY.id, _REGISTRY.appId, _REGISTRY.userId, _REGISTRY.tokens, _REGISTRY.expiry, _REGISTRY.deletedAt, _REGISTRY.verifiedAt, _REGISTRY.ipAddress, _REGISTRY.agent, _REGISTRY.updatedAt], required: [_REGISTRY.appId, _REGISTRY.userId, _REGISTRY.tokens, _REGISTRY.expiry] },
	apiKeys:          { fields: [_REGISTRY.id, _REGISTRY.userId, _REGISTRY.name, _REGISTRY.hash, _REGISTRY.encrypted, _REGISTRY.expiresAt, _REGISTRY.deletedAt, _REGISTRY.lastUsedAt, _REGISTRY.updatedAt], required: [_REGISTRY.userId] },
	...
	auditLogs:        { fields: [_REGISTRY.id, _REGISTRY.appId, _REGISTRY.userId, _REGISTRY.requestId, _REGISTRY.operation, _REGISTRY.target, _REGISTRY.delta, _REGISTRY.auditContext] },
	mfaSecrets:       { fields: [_REGISTRY.id, _REGISTRY.userId, _REGISTRY.encrypted, _REGISTRY.backups, _REGISTRY.enabledAt, _REGISTRY.deletedAt, _REGISTRY.updatedAt], required: [_REGISTRY.userId], unique: [[_REGISTRY.userId]] },
	...
	jobs:             { fields: [_REGISTRY.jobId, _REGISTRY.appId, _REGISTRY.type, _REGISTRY.status, _REGISTRY.priority, _REGISTRY.payload, _REGISTRY.output, _REGISTRY.history, _REGISTRY.retry, _REGISTRY.scheduledAt, _REGISTRY.correlation, _REGISTRY.completedAt, _REGISTRY.updatedAt], required: [_REGISTRY.jobId, _REGISTRY.appId, _REGISTRY.type, _REGISTRY.status, _REGISTRY.priority, _REGISTRY.payload, _REGISTRY.history, _REGISTRY.retry] },
	jobDlq:           { fields: [_REGISTRY.id, _REGISTRY.source, _REGISTRY.sourceId, _REGISTRY.appId, _REGISTRY.dlqContext, _REGISTRY.type, _REGISTRY.payload, _REGISTRY.errorReason, _REGISTRY.attempts, _REGISTRY.errors, _REGISTRY.replayedAt] },
	notifications:    { fields: [_REGISTRY.id, _REGISTRY.appId, _REGISTRY.userId, _REGISTRY.channel, _REGISTRY.template, _REGISTRY.status, _REGISTRY.recipient, _REGISTRY.payload, _REGISTRY.delivery, _REGISTRY.retry, _REGISTRY.correlation, _REGISTRY.updatedAt] },
	...
	webauthnCredentials: { fields: [_REGISTRY.id, _REGISTRY.userId, _REGISTRY.credentialId, _REGISTRY.publicKey, _REGISTRY.counter, _REGISTRY.authenticator, _REGISTRY.name, _REGISTRY.lastUsedAt, _REGISTRY.deletedAt, _REGISTRY.updatedAt] },
