...
const _REGISTRY = {
    ...
    batchKey:         { col: 'batch_key',          field: 'batchKey',         gen: 'stored',    sql: 'TEXT'        },
    chatJson:         { col: 'chat_json',          field: 'chatJson',         sql: 'TEXT'                          },
    ...
    dedupeKey:        { col: 'dedupe_key',         field: 'dedupeKey',        gen: 'stored',    sql: 'TEXT'        },
    ...
    durationMs:       { col: 'duration_ms',        field: 'durationMs',       sql: 'INTEGER'                       },
    ...
    jobKey:           { col: 'job_key',            field: 'jobKey',           gen: 'stored',    sql: 'TEXT'        },
    ...
    loopState:        { col: 'loop_state',         field: 'loopState',        sql: 'JSONB'                         },
    ...
    stateHash:        { col: 'state_hash',         field: 'stateHash',        sql: 'TEXT'                          },
    ...
    toolCallCount:    { col: 'tool_call_count',    field: 'toolCallCount',    sql: 'INTEGER'                       },
