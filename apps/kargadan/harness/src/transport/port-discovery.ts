...
const _portFileSchema = S.Struct({
    pid:       S.Int,
    port:      S.Int,
    startedAt: S.String,
});
const _decodePortFile = S.decodeUnknown(S.parseJson(_portFileSchema));
...
export { PortFileInvalid, PortFileNotFound, PortFileStale, readPortFile };
